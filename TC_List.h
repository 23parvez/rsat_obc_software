...
#pragma pack(1)
	    struct ADCS_Data_TC
	    {
			...
			float TC_Mag_Misalignment_IMU1;												//offset = 12// REMOVE
			float TC_Mag_Misalignment_IMU2;												//offset = 13// REMOVE
			float TC_Mag_Scale_Factor_IMU1;												//offset = 14// REMOVE
			float TC_Mag_Scale_Factor_IMU2;												//offset = 15// REMOVE
			float TC_ACC_Ang_RESET;														//offset = 16// REMOVE
			float TC_SS_misalnCM1256;													//offset = 17// REMOVE
			float TC_SS_misalnCM2356;													//offset = 18// REMOVE
			float TC_SS_misalnCM3456;													//offset = 19// REMOVE
			float TC_SS_misalnCM4156;													//offset = 20// REMOVE
			...
			float TC_JulianDay_at_OBT0;													/*offset = 32*/// REMOVE
			float TC_OBT_Drift_Corr;													/*offset = 33*/// REMOVE
			...
			float TC_Error_dev_SunlitAD;												/*offset = 43*/// REMOVE
			float TC_Error_dev_EclipseAD;												/*offset = 44*/// REMOVE

...
extern void rHILS_packets(void);
...
#define TC_Main_Cells 0 // #define TC_Redundant_Cells 1
...
//Ecef to ECI to ecef
extern double UT1, UTC_EE, TC_delUT1, TAI, JDTDT, M_quad, sine1, sine2, TDB, TDT, TTDB, JDTDB, TTDB2, TTDB3, zeta, z, theta;
...
extern void rMatMul43x1(double mat43[4][3], double vec31[3]);
...
extern int wheel_index[4], wheel_index_ARCsum, Wheel_Config, RW_ARC_Logic, RW_ARC_Count, count_arc_w0, TC_ARC_Time_Cycle, count_arc_w1, count_arc_w2, count_arc_w3;
...
//extern struct SunSensor_Database SS_Main_2Exe_DB;
...
extern void rSS_Read_Data(unsigned long int *ADC_Data_Addr);
extern void rSunSensorVectorComp(double SS_ARRAY[8], struct SunSensor_Database *SS_2Exe_Addr);
extern void rIMUDataCorrection(struct IMU_READ_DATA* IMU_DATA_ADDRS,struct IMU_Database* IMU_CORR);
extern double rTheta_Limit(double var_theta_lim);

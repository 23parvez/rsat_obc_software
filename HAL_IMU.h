...
#define IMU_DATA_READY      		  0x00000100
...
unsigned long int inter_HAL_IMU_Control_Data;
...
unsigned short inter_HAL_IMU_Status_Data_2;

struct HAL_IMU_Data_Structure
{
	unsigned long int IMU_Configure_Register;
    unsigned long int IMU_Buffer_Address;
	unsigned long int IMU_Status_Register_1;
	unsigned long int IMU_Status_Register_2;

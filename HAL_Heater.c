...
{
	unsigned short tempdata;
	if(ADC_Buffer[1] >= LTP[1]) //20 degree = 1.1 volt
		{
	...
	else if(ADC_Buffer[1] <= UTP[1]) //25 degree = 0.922509225 volt
	    {
...
{
	unsigned short tempdata;
	if(ADC_Buffer[2] >= LTP[2]) //20 degree = 1.1 volt
		{
	...
	else if(ADC_Buffer[2] <= UTP[2]) //25 degree = 0.922509225 volt
	    {
...
{
	unsigned short tempdata;
	if(ADC_Buffer[3] >= LTP[3]) //20 degree = 1.1 volt
		{
	...
	else if(ADC_Buffer[3] <= UTP[3]) //25 degree = 0.922509225 volt
	    {
...
{
	unsigned short tempdata;
	if(ADC_Buffer[4] >= LTP[4]) //20 degree = 1.1 volt
		{
	...
	else if(ADC_Buffer[4] <= UTP[4]) //25 degree = 0.922509225 volt
	    {
...
{
	unsigned short tempdata;
	if(ADC_Buffer[5] >= LTP[5]) //20 degree = 1.1 volt
		{
	...
	else if(ADC_Buffer[5] <= UTP[5]) //25 degree = 0.922509225 volt
	    {

...
root_IMU1_Corr IMU1_Corr;
root_IMU2_Corr IMU2_Corr;
root_IMU1_DATA IMU1_DATA;
root_IMU2_DATA IMU2_DATA;
root_SS_Main_2Exe_DB SS_Main_2Exe_DB;
root_SS_Redundant_2Exe_DB SS_Redundant_2Exe_DB;
...
double T_RW_NETk[3], T_MTk[3], Mk[3], T_NETk[3], w_k[3], RWSpeedk[4];
...
double kfom[4][4], kfT_RW_NET_temp[4], kfT_RW_NET[3], kfH_wh_ind[4], kfH_wh2body[3], kfI_MAT_w0[3], kfI_MAT_w0_HW2B[3], kfT_NET[3], kfw0crossI_MAT_w0_HW2B[3], kfw_dot_temp[3];
...
int Present_OBT;
unsigned long int OBT_at_TLE_epoch;
double Delta_TLE;
...
double ep, xl, sinip, cosip, xincp, argpp, nodep, mp, axnl, aynl, esine;
...
double templ_op, am_temp, nm_temp, mm_temp, u_temp, el2, pl, rl, rdotl, rvdotl;
...
unsigned int MTR_ActuationCycle;
...
double T_RW_sdump[4];
int wh_sdump_start[4];
double TB_sMD[3], u_parl[3], T_RWB[3];
double del_Vw[4];
...
WhMom0[4], ActWhMom[4], LossWhMom[4], LossWhMomFilt[4], DFCTorq[4];
...
unsigned int CB_DAD_quest;
unsigned int CB_QuestDataProcessing;
unsigned int CB_ErrorComputation;
unsigned int CB_ExtendedKalmanFilter;
unsigned int CB_LinearController;
unsigned int CB_Wheel_OverSpeed_TorqueCutOff;
unsigned int CB_DutyCycleGeneration;
unsigned int CB_AngularMomentumDumping;
unsigned int CB_SpeedBasedMomentumDumping;
unsigned int CB_Wheel_Dynamic_Friction;
unsigned int CB_Wheel_Spin_updown;
unsigned int CB_Wheel_Auto_Reconfiguration;
unsigned int CB_Two_RW_control;
unsigned int CB_Torquer_Polarity_Check;
unsigned int CB_MagFieldComp;
unsigned int CB_Sun_model;
unsigned int CB_ReferenceQuatComputation;
unsigned int CB_RefVectorGeneration;
unsigned int CB_RefRate_Computation;
unsigned int CB_Sl_Ecl_OnBrd_detection;
unsigned int CB_IMUDataProcessing;
unsigned int CB_SunSensorDataProcessing;
unsigned int CB_BDOT_Computation;
...
double SS_Data[16], SSMAIN_ARRAY[8], SSREDT_ARRAY[8];
